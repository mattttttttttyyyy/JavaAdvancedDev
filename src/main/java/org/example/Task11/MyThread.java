...
Override the run() method to display the thread name in the console by reading it from the static method of the current thread:
        ...
        Inside the main method, create a variable of our previously created class type,
        for example MyThread, and initialize the class. Call the start() method on the variable to execute the thread.
*/
